...
initialCards.forEach((element) => {
  const cardElement = createCard(cardTemplate, element, deleteCard, likeCard, openPopup, popupImg);
...
newPlace.addEventListener("submit", (evt) => {
  ...
  const newCard = createCard(cardTemplate, cardData, deleteCard, likeCard, openPopup, popupImg);
